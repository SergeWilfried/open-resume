...
const QAS = [
    ...
    answer: (
      <>
        ...
        <p>
          ...
          Curriculum saves time and prevents formatting mistakes by
  ...
  {
    question:
      "Q2. What uniquely sets Curriculum apart from other resume builders and templates?",
    answer: (
      <>
        <p>
          Other than Curriculum, there are some great free resume builders out
          there, e.g. <Link href="https://rxresu.me/">Reactive Resume</Link>,{" "}
          <Link href="https://flowcv.com/">FlowCV</Link>. However, Curriculum
          stands out with 2 distinctive features:
        </p>{" "}
        <p>
          <span className="font-semibold">
            1. Curriculum is designed specifically for the U.S. job market and
            best practices.
          </span>
          <br />
          Unlike other resume builders that target a global audience and offer
          many customization options, Curriculum intentionally only offers
  ...
  {
    question: "Q3. Who created Curriculum and why?",
    answer: (
      <p>
        ...
        that led to Curriculum, where we integrated best practices and our
        knowledge into this resume builder. Our hope is that Curriculum can help
  ...
  {
    question: "Q4. How can I support Curriculum?",
    answer: (
      <>
        <p>
          The best way to support Curriculum is to share your thoughts and
        ...
        <p>
          Another great way to support Curriculum is by spreading the words.
